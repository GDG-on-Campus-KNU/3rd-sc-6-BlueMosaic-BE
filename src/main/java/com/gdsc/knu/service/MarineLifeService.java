...
public class MarineLifeService {
    ...
    public void processMarineImageAnalysis(GetImageResponseDto getImageResponseDto) {
        ...
        int score = calculateMarineScore(getImageResponseDto.getUserId(), marineApiResultDto);
        rankingService.createRanking(getImageResponseDto.getUserId(), score);
    }

    private int calculateMarineScore(long userId, MarineApiResultDto marineApiResultDto) {
        // TODO : Implement marine score calculation logic.
        return 0;
    }
}
